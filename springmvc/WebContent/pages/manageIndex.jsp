    ...
    <div class="layui-layout layui-layout-admin" id="myApp" v-cloak>
        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="gdlb" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd data-name="console" class="layui-this"><a lay-href="javascript:;"  class="layui-nav-erjinav">房屋申请处理</a></dd>
              </dl>
              <dl class="layui-nav-child">
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="tenantList" frameborder="0" class="layadmin-iframe" id="iframe01"></iframe>
      </div>
      </div>
